...
export default function SettingsPage({
  ...
  const handleMainCurrencyChange = (
        ...
        <div className="max-w-[700px]">
            ...
            <select
              ...
              onChange={(e) =>
                handleMainCurrencyChange(
                  e.target.value as "USD" | "PLN" | "EUR" | "GBP",
                )
              }
              className="relative box-border flex w-[120px] cursor-pointer content-stretch items-center justify-between rounded-[8px] border border-solid border-black bg-white p-[10px] font-['Roboto_Flex:Regular',sans-serif]  leading-[normal] font-normal text-black not-italic"
            >
            ...
            {currencies
              ...
              .map((currency) => (
                <div key={currency} className="flex items-center gap-4">
                  <div className="relative box-border flex w-[200px] content-stretch items-center justify-between rounded-[8px] p-[10px]">
                    <div
                      aria-hidden="true"
          ...
          <div className="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            <p className="text-sm text-gray-600">
              ...
              equals 1 unit of the target currency. For example, if 1 PLN = 0.27
              USD, enter 0.27 for PLN when USD is your main currency.
            </p>
          </div>
        </div>
      </div>
