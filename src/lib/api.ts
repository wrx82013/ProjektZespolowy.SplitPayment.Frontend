...
import { CreateSplitPaymentRequestDto, SplitPaymentResponseDto } from '../types/api';

const API_BASE_URL = 'http://3.71.231.81';

export const createSplitPayment = async (data: CreateSplitPaymentRequestDto): Promise<SplitPaymentResponseDto> => {
...
export const getSplitPayment = async (id: string): Promise<SplitPaymentResponseDto> => {
