import svgPaths from "../imports/svg-0t6gp3rqdf";
  ...
  return (
    <div className="relative flex w-full shrink-0 content-stretch items-center gap-[16px]">
      ...
      <div className="relative flex shrink-0 content-stretch items-center gap-[15px]">
        <button
          onClick={onDelete}
          className="relative size-[39px] shrink-0 rounded-[8px] bg-[#cb5757] transition-colors hover:bg-[#b54949]"
        >
          <TrashIcon />
        </button>
        <button
          onClick={onEdit}
          className="relative size-[39px] shrink-0 rounded-[8px] bg-[#57cbab] transition-colors hover:bg-[#48b89a]"
        >
          <EditIcon />
        </button>
      </div>
